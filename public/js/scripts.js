...
window.matchMedia || (window.matchMedia = function() {
    ...
    function(a, b, c) {
            ...
            for (var j = 0, k = b.length; j < k; j++)
                if (c = b[j], d = c.parentNode, e = void 0, f = void 0, "IMG" === c.nodeName.toUpperCase() && (c[g.ns] || (c[g.ns] = {}), i.reevaluate || !c[g.ns].evaluated)) {
                    if (d && "PICTURE" === d.nodeName.toUpperCase()) {
                        if (g.removeVideoShim(d), (e = g.getMatch(c, d)) === !1) continue
                    } else e = void 0;
        ...
        function f() {
            ...
            var d, f = setInterval(function() {
                    if (e(), /^loaded|^i|^c/.test(b.readyState)) return void clearInterval(f)
                }, 250),
                h = function() {
                    e({
                        reevaluate: !0
        ...
        g.ns = "picturefill",
            function() {
                ...
                return b.body.appendChild(g.lengthEl), c = g.lengthEl.offsetWidth, c <= 0 && (c = !1), b.body.removeChild(g.lengthEl), c
                ...
                for (var b = [];
                    ...
                    if (d !== -1) {
                        c = a.slice(0, d);
                        if ("," !== c.slice(-1) && "" !== c || (c = c.replace(/,+$/, ""), e = ""), a = a.slice(d + 1), null === e) {
                            var f = a.indexOf(",");
                            f !== -1 ? (e = a.slice(0, f), a = a.slice(f + 1)) : (e = a, a = "")
                        }
                    } else c = a, a = "";
                    (c || e) && b.push({
                        url: c,
    ...
    function(a) {
        ...
        b = function() {
            ...
            return c = d.options.centerMode === !0 ? d.slideWidth * Math.floor(d.options.slidesToShow / 2) : 0, d.options.swipeToSlide === !0 ? (d.$slideTrack.find(".slick-slide").each(function(e, f) {
                if (f.offsetLeft - c + a(f).outerWidth() / 2 > d.swipeLeft * -1) return b = f, !1
            ...
            a(window).width() !== b.windowWidth && (clearTimeout(b.windowDelay), b.windowDelay = window.setTimeout(function() {
                b.windowWidth = a(window).width(),
                    b.checkResponsive(), b.unslicked || b.setPosition()
            }, 50))
        }, b.prototype.removeSlide = b.prototype.slickRemove = function(a, b, c) {
            var d = this;
            if ("boolean" == typeof a ? (b = a, a = b === !0 ? 0 : d.slideCount - 1) : a = b === !0 ? --a : a, d.slideCount < 1 || a < 0 || a > d.slideCount - 1) return !1;
            ...
            var d, e, f, g, h = null,
                i = this;
            if (b = b || !1, (i.animating !== !0 || i.options.waitForAnimate !== !0) && !(i.options.fade === !0 && i.currentSlide === a || i.slideCount <= i.options.slidesToShow)) {
                if (b === !1 && i.asNavFor(a), d = a, h = i.getLeft(d), g = i.getLeft(i.currentSlide), i.currentLeft = null === i.swipeLeft ? g : i.swipeLeft, i.options.infinite === !1 && i.options.centerMode === !1 && (a < 0 || a > i.getDotCount() * i.options.slidesToScroll)) return void(i.options.fade === !1 && (d = i.currentSlide, c !== !0 ? i.animateSlide(g, function() {
                    i.postSlide(d)
                }) : i.postSlide(d)));
                if (i.options.infinite === !1 && i.options.centerMode === !0 && (a < 0 || a > i.slideCount - i.options.slidesToScroll)) return void(i.options.fade === !1 && (d = i.currentSlide, c !== !0 ? i.animateSlide(g, function() {
                    i.postSlide(d)
                }) : i.postSlide(d)));
                if (i.options.autoplay === !0 && clearInterval(i.autoPlayTimer), e = d < 0 ? i.slideCount % i.options.slidesToScroll != 0 ? i.slideCount - i.slideCount % i.options.slidesToScroll : i.slideCount + d : d >= i.slideCount ? i.slideCount % i.options.slidesToScroll != 0 ? 0 : d - i.slideCount : d, i.animating = !0, i.$slider.trigger("beforeChange", [i, i.currentSlide, e]), f = i.currentSlide, i.currentSlide = e, i.setSlideClasses(i.currentSlide), i.updateDots(), i.updateArrows(), i.options.fade === !0) return c !== !0 ? (i.fadeSlideOut(f), i.fadeSlide(e, function() {
                    i.postSlide(e)
    ...
    function(a, b) {
        "object" == typeof exports && exports && "string" != typeof exports.nodeName ? b(exports) : "function" == typeof define && define.amd ? define(["exports"], b) : (a.Mustache = {}, b(a.Mustache))
    }(this, function(a) {
        function b(a) {
        ...
        function i(b, c) {
            ...
            for (var y, z, A, B, C, D, E = new l(b); !E.eos();) {
                if (y = E.pos, A = E.scanUntil(h))
                    for (var F = 0, G = A.length; F < G; ++F) B = A.charAt(F), g(B) ? q.push(o.length) : s = !0, o.push(["text", B, y, y + 1]), y += 1, "\n" === B && e();
                if (!E.scan(h)) break;
                ...
                if (C = [z, A, y, E.pos], o.push(C), "#" === z || "^" === z) n.push(C);
                    ...
                    if (!(D = n.pop())) throw new Error('Unopened section "' + A + '" at ' + y);
        ...
        function j(a) {
            for (var b, c, d = [], e = 0, f = a.length; e < f; ++e)(b = a[e]) && ("text" === b[0] && c && "text" === c[0] ? (c[1] += b[1], c[3] = b[3]) : (d.push(b), c = b));
            return d
        }
        ...
        l.prototype.eos = function() {
            ...
            for (var e, f, g, h = "", i = 0, j = a.length; i < j; ++i) g = void 0, e = a[i], f = e[0], "#" === f ? g = this.renderSection(e, b, c, d) : "^" === f ? g = this.renderInverted(e, b, c, d) : ">" === f ? g = this.renderPartial(e, b, c, d) : "&" === f ? g = this.unescapedValue(e, b) : "name" === f ? g = this.escapedValue(e, b) : "text" === f && (g = this.rawValue(e)), void 0 !== g && (h += g);
            return h
            ...
            if (i) {
                if (p(i))
                    for (var j = 0, k = i.length; j < k; ++j) h += this.renderTokens(a[4], c.push(i[j]), d, e);
    ...
    function(a) {
        ...
        b.on("click", function(b) {
            var d = a(this);
            d.hasClass(c) ? d.removeClass(c) : d.addClass(c), d.next().stop().slideToggle(), b.preventDefault()
        })
    }(jQuery),
    function(a) {
    ...
    function(a) {
        function b() {
            if (d.length > 0) {
                ...
                var b = 1;
                a(".brand-item").hide().addClass("hidden"), a.each(d, function(c, d) {
                    a(".brand-item.hidden." + d).each(function() {
                        b <= e && a(this).show().removeClass("hidden"), b++
                    })
                })
            } else c()
        }
        ...
        function c() {
            a(".brand-item").hide().addClass("hidden"), a(".brand-item").slice(0, e).show().removeClass("hidden"), a(".js-brands__clear").hide()
        }
        ...
        a(".js-category-selector").click(function() {
            ...
            a(this).toggleClass("category-selector--active"), a.inArray(c, d) !== -1 ? d.splice(d.indexOf(c), 1) : d.push(c), b()
        }), a(".js-brands__more").click(function(c) {
            c.preventDefault(), e += 8, e >= f && a(this).hide(), b()
        }), a(".js-brands__clear").click(function() {
            d = [], c(), a(".js-category-selector.category-selector--active").removeClass("category-selector--active")
        })
    }(jQuery),
    function(a) {
        var b = a("body"),
        ...
        if (g.find(".overlay-carousel__item").remove(), a(".js-brands-carousel").length)
            for (var i = 0; i < overlayData.length; i++) {
                var j = overlayData[i],
                    k = h.clone(!0);
                k.find(".overlay-carousel__item-title").html(j.Title), k.find(".overlay-carousel__item-content").html(j.Text);
                ...
                a(m).attr("src", j.Image), g.append(k)
            }
        d.on("click", function(d) {
            var e = a(window).scrollTop(),
                h = (a(window).scrollTop(), a(this).data("brand-index"));
            c.addClass("overlay__container"), b.addClass("overlay__container").append(f), f.show(), window.scrollTo(0, 0), g.slick({
                dots: !1,
                adaptiveHeight: !0,
                slidesToShow: 1,
                draggable: !1,
                ...
                f.fadeOut(function() {
                    b.removeClass("overlay__container"), c.removeClass("overlay__container"), g.slick("unslick"), a(window).scrollTop(e), f.remove()
                }), d.preventDefault()
            }), d.preventDefault()
        })
    }(jQuery),
        ...
        a(".js-cookie-policy-agree").on("click", function(b) {
            ...
            setTimeout(function() {
                a(c).closest(".cookie-policy").slideUp(600, function() {
                    a(this).remove(), a(".main-nav").data("topPosition", a(".main-nav").offset().top)
                })
            }, 300)
        })
    }(jQuery),
    function(a) {
        ...
        d.on("click", function(d) {
            var e = a(window).scrollTop();
            window.scrollTo(0, 0), c.addClass("overlay__container"), b.addClass("overlay__container").append(f), f.fadeIn(), a(".overlay--follow .brand-social__icon").each(function() {
                var b = a(this).data("icon-alias");
                a(this).attr("src", "/images/social-" + b + ".png"), a(this).attr("srcset", "/images/social-" + b + ".png 1x, /images/social-" + b + "@2x.png 2x")
            }), f.find(".js-overlay-close").on("click", function() {
                b.removeClass("overlay__container"), c.removeClass("overlay__container"), f.fadeOut(function() {
                    a(window).scrollTop(e), f.remove()
                })
            }), d.preventDefault()
        })
    }(jQuery),
    function(a) {
        a(".global-locations__button").click(function() {
            ...
            a(".js-overlay-close-global").click(function(b) {
                b.preventDefault(), a(this).closest(".overlay").hide()
            })
        });
    }(jQuery),
    function(a) {
    ...
    function(a) {
        if (a(".rotate__modules-wrapper").length) {
            ...
            a(b).addClass("rotate__module--top"), a(c).addClass("rotate__module--bottom");
            ...
            a(".rotate__module-background-image").each(function() {
                a(a(this).closest(".rotate__module")).addClass("rotate__module-with-image")
            })
        }
    }(jQuery),
    function() {
        ...
        function b() {
            ...
            for (a = 0; a < b.length && !v; a += 1) v = window[b[a] + "RequestAnimationFrame"];
        ...
        function d(a) {
            ...
            function d(a) {
                c(" Removing iFrame: " + a.id), a.parentNode.removeChild(a), c(" --")
            }
            ...
            function j() {
                ...
                if (x.checkOrigin && (c(" Checking conection is from: " + d), "" + b != "null" && b !== d)) throw new Error("Unexpected message received from: " + b + " for " + v.iframe.id + ". Message was: " + a.data + ". This error can be disabled by adding the checkOrigin: false option.");
                return !0
            }
            ...
            function m() {
                ...
                c(" MessageCallback passed: {iframe: " + v.iframe.id + ", message: " + a + "}"), x.messageCallback({
                    iframe: v.iframe,
                    message: a
                }), c(" --")
            }
            ...
            function n() {
                if (null === v.iframe) throw new Error("iFrame (" + v.id + ") does not exist on " + t);
                return !0
            }
            ...
            function p() {
                switch (v.type) {
                    case "close":
                        d(v.iframe), x.resizedCallback(v);
                        break;
                    case "message":
                        m();
                        break;
                    case "reset":
                        ...
                        break;
                    default:
                        b(), x.resizedCallback(v)
                }
            }
            var u = a.data,
                v = {};
            k() && (c(" Received: " + u), v = e(), !l() && n() && j() && (o = !1, p()))
        }
        ...
        function f() {
            null !== u && (window.scrollTo(u.x, u.y), c(" Set position: " + u.x + "," + u.y), u = null)
        }
        ...
        function h(a) {
            ...
            x.sizeHeight && b("height"), x.sizeWidth && b("width")
        }

        function i(a, b, d) {
            d !== b.type && v ? (c(" Requesting animation frame"), v(a)) : a()
        }

        function j(a, b, d) {
            c("[" + a + "] Sending msg to iframe (" + b + ")"), d.contentWindow.postMessage(r + b, "*")
        }

        function k() {
            function b(a) {
                return "" === a && (i.id = a = "iFrameResizer" + n++, c(" Added missing iframe ID: " + a)), a
            }

            function d() {
                c(" IFrame scrolling " + (x.scrolling ? "enabled" : "disabled") + " for " + k), i.style.overflow = !1 === x.scrolling ? "hidden" : "auto", i.scrolling = !1 === x.scrolling ? "no" : "yes"
            }

            function e() {
                ("number" == typeof x.bodyMargin || "0" === x.bodyMargin) && (x.bodyMarginV1 = x.bodyMargin, x.bodyMargin = x.bodyMargin + "px")
            }
            ...
            function h(b) {
                a(i, "load", function() {
                    j("iFrame.onload", b, i), !o && x.heightCalculationMethod in w && g({
                        iframe: i,
                        height: 0,
                        width: 0,
                        type: "init"
        ...
        function l() {
            function a(a) {
                if ("IFRAME" !== a.tagName) throw new TypeError("Expected <IFRAME> tag, found <" + a.tagName + ">.");
                k.call(a)
            }

            function b(a) {
                if ("object" != typeof(a = a || {})) throw new TypeError("Options is not an object.");
                for (var b in y) y.hasOwnProperty(b) && (x[b] = a.hasOwnProperty(b) ? a[b] : y[b])
            }
        ...
        function m(a) {
            a.fn.iFrameResize = function(b) {
                return x = a.extend({}, y, b), this.filter("iframe").each(k).end()
            }
        }
        var n = 0,
            o = !0,
        ...
        b(), a(window, "message", d), l(), "jQuery" in window && m(jQuery)
    }(), iFrameResize({
        log: !1,
        enablePublicMethods: !1
    }),
    ...
    function(a) {
        ...
        var e = function() {
            ...
            b = setInterval(function() {
                "object" == typeof YT && (c(), clearInterval(b))
            }, 500), a(".yt_video-title").click(function() {
                a(this).fadeOut(500, function() {
                    d[a(this).next().find("iframe").attr("id")].playVideo()
                })
            })
        };
    ...
    function(a, b, c) {
        ...
        function e() {
            ...
            for (var i in p)
                if (p.hasOwnProperty(i)) {
                    if (a = [], b = p[i], b.name && (a.push(b.name.toLowerCase()), b.options && b.options.aliases && b.options.aliases.length))
                        for (c = 0; c < b.options.aliases.length; c++) a.push(b.options.aliases[c].toLowerCase());
                    for (e = d(b.fn, "function") ? b.fn() : b.fn, f = 0; f < a.length; f++) g = a[f], h = g.split("."), 1 === h.length ? r[h[0]] = e : (!r[h[0]] || r[h[0]] instanceof Boolean || (r[h[0]] = new Boolean(r[h[0]])), r[h[0]][h[1]] = e), o.push((e ? "" : "no-") + h.join("-"))
                }
        }
        ...
        function f(a) {
            ...
            if (t && (b = b.baseVal), r._config.enableJSClass) {
                var d = new RegExp("(^|\\s)" + c + "no-js(\\s|$)");
                b = b.replace(d, "$1" + c + "js$2")
            }
            r._config.enableClasses && (b += " " + c + a.join(" " + c), t ? s.className.baseVal = b : s.className = b)
        }
        ...
        function k() {
            var a = b.body;
            return a || (a = h(t ? "svg" : "body"), a.fake = !0), a
        }
        ...
        function l(a, c, d, e) {
            ...
            return f = h("style"), f.type = "text/css", f.id = "s" + l, (n.fake ? n : m).appendChild(f), n.appendChild(m), f.styleSheet ? f.styleSheet.cssText = a : f.appendChild(b.createTextNode(a)), m.id = l, n.fake && (n.style.background = "", n.style.overflow = "hidden", j = s.style.overflow, s.style.overflow = "hidden", s.appendChild(n)), g = c(m, a), n.fake ? (n.parentNode.removeChild(n), s.style.overflow = j, s.offsetHeight) : m.parentNode.removeChild(m), !!g
        }
        ...
        function n(a, b, e, f) {
            ...
            for (var l, n, o, p, q, r = ["modernizr", "tspan"]; !v.style;) l = !0, v.modElem = h(r.shift()), v.style = v.modElem.style;
            for (o = a.length, n = 0; o > n; n++)
                if (p = a[n], q = v.style[p], g(p, "-") && (p = i(p)), v.style[p] !== c) {
                    if (f || d(e, "undefined")) return j(), "pfx" != b || p;
                    try {
                        v.style[p] = e
                    } catch (t) {}
                    if (v.style[p] != q) return j(), "pfx" != b || p
                }
            return j(), !1
        }
        var o = [],
        ...
        r.addTest("textshadow", w("textShadow", "1px 1px")), e(), f(o), delete q.addTest, delete q.addAsyncTest;
        for (var x = 0; x < r._q.length; x++) r._q[x]();
        a.Modernizr = r
    }(window, document),
    function(a) {
        var b, c = a(window),
            d = a(".main-nav"),
            e = d.find(".js-main-nav-content"),
            f = d.find(".main-nav__sub"),
            g = d.find(".main-nav__item"),
            h = g.find("svg"),
            i = d.find(".js-toggle-nav"),
            j = e.find(".js-toggle-mobile-nav"),
            k = d.find(".main-nav__search"),
            l = d.find(".main-nav-mobile__search"),
            m = d.find(".main-nav__countries"),
            n = d.find(".main-nav-mobile__country-selector"),
            o = d.find(".main-nav-countries"),
            p = d.find(".main-nav-mobile__search-input"),
            q = p.closest("form"),
            r = d.find(".main-nav-search__results"),
            s = d.find(".main-nav-search__container"),
            t = d.find(".main-nav__list"),
            u = a("#region").val(),
            v = a("#rootId").val(),
            w = a("#noToTake").val(),
            x = a("#mediaRootId").val(),
        ...
        s.css("max-height", G), f.each(function() {
            var b, c = a(this),
                d = c.find("li"),
                e = d.length,
                f = 6,
                g = 0,
                h = 0;
            e > f && (b = a('<div class="' + c.attr("class") + '"></div>'), d.each(function() {
                var a = this;
                h % f == 0 && (b = b.append('<ul class="main-nav__sublist"></ul>'), g++), b.find("ul:last-child").append(a), h++
            }), b.addClass("has-sublist has-sublist--" + g), c.replaceWith(b))
        });
        var H = function() {
                d.data("topPosition", d.offset().top);
                var b, e, f, g = function() {
                    b = d.data("topPosition"), e = c.scrollTop(), f = d.hasClass(z), e >= b && !f ? d.addClass(z).fadeIn() : e < b && d.removeClass(z), e === b ? d.addClass(A) : d.hasClass(A) && d.removeClass(A)
                };
                g(), c.on("scroll.listenForMainNavFix", function() {
                    g()
            ...
            I = function() {
                d.removeClass(z), d.removeClass(A), c.off("scroll.listenForMainNavFix")
            };
        q.submit(function(a) {
            a.preventDefault()
        });
        var J = function() {
                k.on("click", function(a) {
                    l.fadeIn(300).find('input[type="text"]').focus().closest(".main-nav__wrapper").addClass(E), d.addClass(E), o.is(":visible") && o.slideUp(300), a.preventDefault()
                }), j.on("click", function(b) {
                    l.fadeOut(300, function() {
                        a(this).closest(".main-nav__wrapper").removeClass(E)
                    }), b.preventDefault(), d.removeClass(E), N()
                })
            },
            K = function() {
                k.off("click"), j.off("click"), l.removeAttr("style").closest(".main-nav__wrapper").removeClass(E)
            };
        p.keyup(function(a) {
            L()
        });
        var L = function() {
            ...
            M = function(b) {
                s.is(":visible") || s.slideDown(500), r.hasClass(D) || r.addClass(D), a(window).width() < 1024 && a(".main-nav__list").hide();
                var c = q.attr("action");
                a.getJSON(c + "?query=" + b + "&region=" + u + "&rootId=" + v + "&mediaRootId=" + x + "&noToTake=" + w + "&searchMedia=" + y, function(a) {
                    a.hasMedia = a.pdfs.length > 0, a.hasNews = a.news.length > 0, a.hasContent = a.content.length > 0, a.hasLocations = a.locations.length > 0, a.noResults = 0 == (a.hasMedia || a.hasNews || a.hasContent || a.hasLocations);
            ...
            N = function() {
                s.slideUp(300, function() {
                    r.removeClass(D), t.is(":visible") || t.slideDown()
                }), s.html(), p.val("")
            },
            O = function() {
            ...
            P = function(b, c) {
                a(b).toggleClass(B), g.toggleClass(C), l.find("form").toggleClass(C), d.toggleClass(F), o.addClass(D), "function" == typeof c && c()
            };
        ! function() {
            ...
            if (!a("li", b).length) {
                ...
                //         c % 6 == 0 && a(b).append('</ul><ul class="main-nav-countries__list">'), a(b).append('<li class="main-nav-countries__item"><a class="main-nav-countries__link" href="' + e.Url + '">' + e.Name + '<svg height="13" width="13"><use xlink:href="#icon-chevron-right" xmlns:xlink="http://www.w3.org/1999/xlink"/></svg></a>'), c++
                //     });
                // });
            }
            m.on("click.openCountries", function(a) {
                a.preventDefault(), P(this, function() {
        ...
        var Q = function() {
            ...
            R = function() {
                i.off("click.toggleNav"), j.off("click.toggleMobileNav"), e.removeAttr("style")
            },
            S = function(c, d, e) {
                var f = c,
                    g = d || 0,
            ...
            T = function(c, d) {
                var e = c,
                    f = d || 100;
                clearTimeout(b), a(e).removeClass(B).find(".main-nav__sub").stop(!0, !0).removeClass(B).slideUp(f)
            },
            U = function() {
            ...
            V = function() {
                h.off("click.mainNavMobile"), d.find(".main-nav__sub." + B).each(function() {
                    T(a(this).closest(".main-nav__item"), 0)
                })
            },
            W = function() {
                H(), R(), V(), J(), g.on("mouseenter.mainNav", function() {
            ...
            X = function() {
                I(), Q(), U(), T(g), K(), g.off("mouseenter.mainNav").off("mouseleave.mainNav")
            };
        a(document).ready(function() {
            W(), a.fn.responsiveSetup && a(document).responsiveSetup({
                onMobile: {
                    callFunction: X
                },
                onDesktop: {
    ...
    function(a) {
        if (a(".js-news-filter-carousel").slick({
            ...
            a(".news_filter-menu-item-active", c).removeClass("news_filter-menu-item-active"), a(this).addClass("news_filter-menu-item-active"), a(".news-item:visible", c).fadeOut(500, function() {
        ...
        a(".js-news__more").on("click", function(e) {
            ...
            a.ajax({
                ...
                success: function(e) {
                    ...
                    var g = "financial" === m ? "#financialNewsItemTemplate" : "#newsItemTemplate",
                        i = c(e, g);
                    h.append(i), "financial" === m && a(e.NewsItems).each(function() {
                        var b = "",
            ...
            if (!e.hasClass("news_filter-menu-item-active")) {
                var f = e.parents(".news"),
                    ...
                    k = f.data().mode,
                    l = e.data().newsfilter;
                a(f).find(".news_filter-menu-item-active").removeClass("news_filter-menu-item-active"), e.addClass("news_filter-menu-item-active"), a.ajax({
                    type: "GET",
                    url: "/umbraco/Api/LoadMore/GetNewsItems",
                    data: {
                        mode: k,
                    ...
                    success: function(e) {
                        ...
                        var h = "financial" === k ? "#financialNewsItemTemplate" : "#newsItemTemplate",
                            i = c(e, h);
                        g.html(i), "financial" === k && a(e.NewsItems).each(function() {
                            var b = "",
...
RBCookie.Alert = RBCookie.Alert || {
        bind: function() {
            $("#rb-cookie-accept").click(function() {
                var a = RBCookie.key,
                    b = new Date;
                return b.setDate(b.getDate() + 36500), document.cookie = a + "=1; path=/; expires=" + b.toUTCString(), $("#rb-cookie-container").slideUp(function() {
                    $(this).remove()
                }), !1
            })
        }
    ...
    function(a) {
        ...
        d.on("click", function(d) {
            var e = a(window).scrollTop();
            window.scrollTo(0, 0), c.addClass("overlay__container"), b.addClass("overlay__container").append(f), f.fadeIn(), a(".overlay--share .brand-social__icon").each(function() {
                var b = a(this).data("icon-alias");
                a(this).attr("src", "images/social-" + b + ".png"), a(this).attr("srcset", "images/social-" + b + ".png 1x, images/social-" + b + "@2x.png 2x")
            }), f.find(".js-overlay-close").on("click", function() {
                b.removeClass("overlay__container"), c.removeClass("overlay__container"), f.fadeOut(function() {
    ...
    function(a) {
        a.getScript("//hsprod.investis.com/servlet/HsPublic?context=ir.access&ir_client_id=6365&ir_option=PRICES_DELAYED&transform=lse_prices_js", function() {
            function b() {
                ...
                a(b).length && a(b).visible() && !a(b).hasClass("spf-animated") && (a(b).addClass("spf-animated"), a({
                    someValue: 5e3
                }).animate({
                    someValue: lasttrade
                }, {
            ...
            function c(a) {
                for (;
                    /(\d+)(\d{3})/.test(a.toString());) a = a.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                return a
            }
            if ("undefined" != typeof lasttrade) {
                ...
                var d = new Date,
                    ...
                    f = d.getMonth() + 1,
                    g = d.getFullYear();
                if (e == day && f == theMonth && g == year) var h = "Today";
                else var h = day + "/" + theMonth + "/" + year;
                var i = hour + "." + min + " " + h;
                if (perc < 0);
                else if (perc > 0);
                else;
                a(".spt_updated-time").html(i), a(".spt_change-percentage").html(perc + "%"), a(".spt_change-figure").html(change + ".00"), a(window).load(function() {
                    b()
    ...
    function(a) {
        a.fn.worldMapSetup = function() {
            var b, c, d = a(this),
                e = (d.find(".world-map__svg"), d.find(".world-map__overlay"), d.offset().top),
                f = 0;
            b = [{
                addClass: "is-map-1",
            ...
            var g = function() {
                ...
                for (var e in b) b.hasOwnProperty(e) && (c >= b[e].startPos - f ? b[e].isActives || (d.addClass(b[e].addClass), b[e].isActives = !0, b[e].inFunction && b[e].inFunction()) : b[e].isActives && (d.removeClass(b[e].addClass), b[e].isActives = !1, b[e].outFunction && b[e].outFunction()))
            };
            g(), a(window).on("resize.world-map", function() {
                f = e - d.offset().top
