...
@section('overlay-scripts')
    ...
    var overlayData = 
        [
            ...
            {"Title":"Daily Feed","Text":"","Image":"{{ url('storage/uploads/products/product3.png') }}","LinkName":"Daily Feed","Link":""},
            ...
            {"Title":"Khushal Mix Atti","Text":"","Image":"{{ url('storage/uploads/products/product5.png') }}","LinkName":"Khushal Mix Atti","Link":""},
            ...
            {"Title":"Masoor Atti","Text":"","Image":"{{ url('storage/uploads/products/product7.png') }}","LinkName":"Masoor Atti","Link":""},
            {"Title":"Masoor Qutta","Text":"","Image":"{{ url('storage/uploads/products/product8.png') }}","LinkName":"Masoor Qutta","Link":""},
            {"Title":"Milk Booster","Text":"","Image":"{{ url('storage/uploads/products/product9.png') }}","LinkName":"Milk Booster","Link":""},
            ...
            {"Title":"Mix Atti","Text":"","Image":"{{ url('storage/uploads/products/product12.png') }}","LinkName":"Mix Atti","Link":""},
            ...
            {"Title":"Moong Husk","Text":"","Image":"{{ url('storage/uploads/products/product14.png') }}","LinkName":"Moong Husk","Link":""},
            ...
            {"Title":"Toor Husk","Text":"","Image":"{{ url('storage/uploads/products/product20.png') }}","LinkName":"Toor Husk","Link":""},
            ...
            {"Title":"Urad Husk","Text":"","Image":"{{ url('storage/uploads/products/product22.png') }}","LinkName":"Urad Husk","Link":""},
